...
$route['loadChangePass'] = "welcome/loadChangePass";
...
$route['addNew'] = "EmployeeController/addNew";
$route['employee/store'] = 'EmployeeController/store';

$route['changePasswordSettings'] = "welcome/changePasswordSettings";
$route['Settings/update'] ='Settings/update';
$route['Settings/update1'] ='Settings/update1';

$route['invoice'] = "invoice/index";
$route['customer'] = "Customer/index";
$route['createInvoive'] = "invoice/createInvoive";
$route['forgotPassword'] = "welcome/forgot_passwordd";
